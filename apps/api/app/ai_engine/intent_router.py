...
INTENT_KEYWORDS: dict[str, list[str]] = {
    ...
    "listar_profissionais": [
        ...
        # ── Frases naturais adicionais (diagnosticadas do problema) ──────────
        "quais medicos existem", "existem medicos", "tem medicos",
        "tem algum neuro", "tem neuro", "tem neurologist", "tem cardi",
        "vocês tem cardiologista", "vocês tem ortopedista", "vocês têm neurologista",
        "tem um neurologista", "tem um cardio", "tem um ortopedista",
        "existe algum médico", "existem médicos", "tem algum médico",
        "quais são os médicos", "quais são os profissionais",
        "me liste os médicos", "relacione os médicos",
        "quais médicos trabalham", "quais médicos existem",
        "quais profissionais existem", "quem são os doutores",
        "quais doutores", "quais médicos atendem", "quais profissionais atendem",
        "a equipe", "time", "staff", "corpo clínico", "corpo medico",
        "profissionais cadastrados", "médicos cadastrados",
        "já estão cadastrados", "quais profissionais disponíveis",
        "quais médicos disponíveis", "quais doutores disponíveis",
        "quais profissionais vocês tem", "quais médicos vcs",
        "me mostra os médicos", "me mostra os profissionais",
        "mostra os médicos", "mostra os doutores",
        "quem são os doutores", "quais profissionais atendem aqui",
        "quais médicos atendem aqui", "que médicos atuam aqui",
        "que profissionais atuam aqui", "quem trabalha aqui",
        "equipe de profissionais", "time de médicos",
        "quais médicos faço", "fazem atendimento",
    ],
