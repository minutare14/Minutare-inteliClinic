    ...
    <div className="space-y-6">
            ...
            <CardBody>
              ...
              <div className="mt-4 pt-3 border-t border-gray-100 flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-xs bg-purple-50 text-purple-700 rounded-lg hover:bg-purple-100 border border-purple-100"
                >
                  {showPipeline ? "Ocultar IA Trace" : "Ver IA Trace"}
                </button>
              </div>
            </CardBody>
          </Card>
      ...
      {showPipeline && (
        <div className="animate-in fade-in slide-in-from-top-4 duration-300">
          <PipelineViewer conversationId={conversation.id} />
        </div>
      )}
    </div>
  );
